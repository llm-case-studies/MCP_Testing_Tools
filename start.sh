...
services=("http://localhost:9090" "http://localhost:9091" "http://localhost:9092")
...
echo ""
echo "📱 Web Portal:    http://localhost:9090"
echo "🧞 Mock Genie:    http://localhost:9091" 
echo "🕵️ Proxy Spy:     http://localhost:9092"
echo ""
