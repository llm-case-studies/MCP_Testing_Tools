...
# =============================================================================
# MCP POSTMAN APIs - Enhanced tool discovery and testing
# =============================================================================

# Storage for request history and collections
mcp_request_history = []
mcp_collections = {}
...
@app.post("/api/mcp/call-tool/{server_name}")
...
@app.post("/api/mcp/collections/{collection_name}")
...
@app.get("/api/mcp/collections/{collection_name}")
...
@app.delete("/api/mcp/collections/{collection_name}")
...
@app.get("/api/mcp/generate-sample/{server_name}/{tool_name}")
